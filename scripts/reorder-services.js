const fs = require('fs');
const path = 'src/data/services-data.ts';

// This is the original servicesData object from the file
const servicesData = {
  ...
  'impianti-geotermici': {
    ...
    introduction: 'LC Energia da diversi anni realizza impianti che utilizzano fonti alternative, in particolare impianti geotermici puri o integrati con altri sistemi di produzione dell dell\'energia, nell\'ambito di una politica di ricerca della massima soddisfazione del cliente.<br><br>Per questo da alcuni anni ormai, la normativa europea prescrive l\'adozione di tecnologie funzionanti con fonti rinnovabili e pulite quali il sole, il vento e il terreno nell\'ambito delle nuove costruzioni e delle ristrutturazioni edilizie.',
    sections: [
      {
        title: 'REALIZZAZIONE',
  ...
  'contributo-pnrr': {
    ...
    sections: [
      ...
      },
      {
        ...
        content: 'Rientrano nell\'incentivo in particolare:',
        list: [
...
const orderedServices = {
  'progettare-il-risparmio-energetico': servicesData['progettare-il-risparmio-energetico'],
  'progettazione-e-consulenza-tecnica': servicesData['progettazione-e-consulenza-tecnica'],
  'progettazione-antincendio': servicesData['progettazione-antincendio'],
  'progettazione-acustica': servicesData['progettazione-acustica'],
  'impianti-geotermici': servicesData['impianti-geotermici'],
  'contabilizzazione-calore-impianti-termici-centralizzati': servicesData['contabilizzazione-calore-impianti-termici-centralizzati'],
  'impianti-fotovoltaici': servicesData['impianti-fotovoltaici'],
  'stazioni-di-ricarica': servicesData['stazioni-di-ricarica'],
  'riqualificazione-di-centrali-termiche-esistenti': servicesData['riqualificazione-di-centrali-termiche-esistenti'],
  'contributo-pnrr': servicesData['contributo-pnrr'],
  'conto-termico': servicesData['conto-termico'],
};
...
s\S]*};
/,
    `export const servicesData: { [key: string]: ServiceData } = ${JSON.stringify(orderedServices, null, 2)};`
  );

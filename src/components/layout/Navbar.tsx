      ...
      <nav className="relative" aria-label="Navigazione principale">
        <div className="flex h-auto items-center">
          ...
          <div className="flex items-center lg:hidden">
            <button
              className="mr-4 inline-flex items-center justify-center rounded-md p-2 text-gray-600 hover:bg-neutral-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 transition-all duration-300"
        ...
        {/* Mobile Menu Panel */}
        {isOpen && (
          <div id="mobile-menu" className="lg:hidden border-t absolute w-full bg-white shadow-lg">

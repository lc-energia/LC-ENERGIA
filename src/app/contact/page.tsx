              ...
              >
                <motion.div variants={cardEntrance} className="mb-4">
                  <div className="p-8 bg-white rounded-xl shadow-card hover-lift hover-shine h-full border border-primary-100">
                    ...
                    <Button asChild variant="outline" className="mt-4 hover:bg-gradient-primary hover:text-white hover:border-primary-500 transition-all">
                ...
                <motion.div variants={cardEntrance} className="mb-4">
                  <div className="p-8 bg-white rounded-xl shadow-card hover-lift hover-shine h-full border border-secondary-100">
                    ...
                    <Button asChild variant="outline" className="mt-4 hover:bg-gradient-secondary hover:text-white hover:border-secondary-500 transition-all">

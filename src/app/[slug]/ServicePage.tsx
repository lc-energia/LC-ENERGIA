...
import { faCheckCircle, faDraftingCompass, faTools, faCertificate } from '@fortawesome/free-solid-svg-icons';
    ...
    <ServicePageLayout title={service.title}>
      ...
      >
        {slug === 'impianti-fotovoltaici' ? (
          <>
            <h6 className="text-gradient-primary font-bold text-lg uppercase">IL NOSTRO INTERVENTO</h6>
            <p className="lead text-xl text-gray-600 leading-relaxed">Progettiamo e installiamo impianti fotovoltaici &quot;chiavi in mano&quot; partendo da una valutazione preliminare che considera i seguenti elementi di base:</p>
          </>
          ...
          <p className="lead text-xl text-gray-600 leading-relaxed" dangerouslySetInnerHTML={{ __html: service.introduction }}></p>
        )}
      </motion.div>
            ...
            <section className="mb-16">
              ...
              >
                <motion.div
                  ...
                  whileInView="visible"
                >
                  <div className="bg-gradient-combined p-1 rounded-full">
        ...
        <div className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-primary-50/30 via-white to-secondary-50/30">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div
              ...
              viewport={viewportSettings}
            >
              <h6 className="text-gradient-primary font-bold text-lg uppercase mb-2">{service.partnersTitle}</h6>
              <p className="text-lg text-gray-600 leading-relaxed">{service.partnersIntroduction}</p>
            </motion.div>
            <motion.div

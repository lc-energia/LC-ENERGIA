...
import { Heading2, Heading6, Text } from '@/components/ui/Typography';
...
export default function AziendaContent() {
  return (
    <>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.div
              ...
              className="relative h-64 lg:h-full min-h-[300px] rounded-xl overflow-hidden shadow-combined hover-lift"
            >
              <Image
      ...
      <section className="reasons-section bg-gradient-secondary py-12 sm:py-16 lg:py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <Heading2 className="text-center mt-2 mb-4 text-white-force text-2xl md:text-3xl lg:text-4xl">I motivi per scegliere LC Energia</Heading2>
          </motion.div>
          <motion.div
